...
writeln('--------------------------------------------------------');
writeln('|'+name_tab(text[91],35)+'|'+name_tab(text[110],11)+'|'+name_tab(text[12],4)+'|'+text[92]+'|'+text[102]+'|'+text[93]+'|');
for toi:=0 to 9 do begin//1
writeln('|'+name_tab(t_o.bag[toi].name,35)+'|'+name_tab(item_info(t_o.bag[toi].tip),11)+'|'+name_tab(inttostr(t_o.bag[toi].base_dmg),4));
end;//1
readln();
end;
