...
if lang_s='w_rus' then   F.AddFileEntry('res\save\map.save','mob.save');
if lang_s='w_rus' then   F.AddFileEntry('res\save\map.save','beast.save');
if lang_s='w_rus' then   F.AddFileEntry('res\save\map.save','oz.save');
 zip:=TZipper.Create;
